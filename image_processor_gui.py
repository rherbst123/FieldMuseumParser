...
class ImageProcessorGUI:
    ...
    def __init__(self, master):
        ...
        ttk.Button(input_frame,bootstyle = "success", text="Browse", command=self.browse_url_file).grid(row=0, column=2, padx=5, pady=5)
        ...
        ttk.Button(input_frame,bootstyle = "success", text="Browse", command=self.browse_api_key_file).grid(row=1, column=2, padx=5, pady=5)
        ...
        ttk.Button(input_frame,bootstyle = "success", text="Browse", command=self.browse_prompt_folder).grid(row=2, column=2, padx=5, pady=5)
        ...
        ttk.Button(input_frame,bootstyle = "success", text="Refresh", command=self.refresh_prompts).grid(row=3, column=2, padx=5, pady=5)
        ...
        self.save_button = ttk.Button(text_frame,bootstyle = "success", text="Save Edits", command=self.save_edits)
